    ...
    'router' => array(
        'routes' => array(
            ...
            'dashboard' => array(
                'type' => 'segment',
                'options' => array(
                    'route'    => '/dashboard[/:action][/:id][/page/:page][/search_by/:search_by]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                        'page' => '[0-9]+',
            ...
            'purchase-order' => array(
                'type' => 'segment',
                'options' => array(
                    'route'    => '/purchase-order[/:action][/:id][/page/:page][/search_by/:search_by]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                        'page' => '[0-9]+',
                    ...
                    'defaults' => array(
                        'controller' => 'PurchaseOrder\Controller\Index',
                        'action'     => 'index',
                    ),
                ),
            ),
            ...
            'meeting' => array(
                'type' => 'segment',
                'options' => array(
                    'route'    => '/meeting[/:action][/:id][/search_by/:search_by]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                        'search_by' => '.*',
                    ...
                    'defaults' => array(
                        'controller' => 'Meeting\Controller\Index',
                        'action'     => 'index',
                    ),
                ),
            ),
